...
L'être humain a besoin de 3 principaux nutriments (macronutriments) :  
- **Lipides** (≈30%) → énergie de réserve, constitution des membranes, hormones (voir [Lipides](../../A1/ch1/g2.md)).
- **Glucides** (≈55%) → principale source d’énergie (voir [Glucides](../../A1/ch1/g3.md)).
- **Protéines** (≈15%) → construction et renouvellement des cellules (voir [Protéines](../../A1/ch1/g5.md)).
...
- **L’intestin grêle (≈6 m)** : lieu principal de digestion et d’absorption.
  - **Foie** : produit la bile (émulsification des lipides).
...
- Les **villosités intestinales** et les **microvillosités** de l’intestin grêle permettent d’augmenter considérablement la surface d’absorption (surface équivalente à un terrain de tennis, environ 200-300 $m^2$).
