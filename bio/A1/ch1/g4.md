...
- Il y a une confusion entre /dashboard et /profile. Je pense que fusionner les 2 ne serait pas une mauvaise idée
- Petit détail : le button "lier son compte" est pas centré : aura-il d'autres comptes à lier (type bedrock)? Sinon, centrer ce petit bouton
  -> Pourquoi avoir 2 connexions Microsoft au lieu d'une ? Il n'y a pas d'interet à avoir un compte ""Craftons!"" sans compte Minecraft? L'interet est plus inverse, des gens qui voudraient juste un billet sans compte. 
- Il y a beaucoups de couleurs "primaires" (sur les boutons). En sois, comme la DA de craftons est basé sur des couleurs différentes, c'est une super idée, mais là il y a 2 rouges et ça m'a trigger. (faire rouger -> violet et jaune -> vert dcp)
- Enfin, le nom de domaine est craftons.lol et pas .fr, dcp il faut modifier sur le mail. Oui je suis aller voir jusque là.