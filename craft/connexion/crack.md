...
Pour l'installation d'une version crack de Minecraft, consultez d'abord [cette page](./installation.md). Certains comptes crack peuvent rencontrer des problèmes de connexion : voici les cas les plus fréquents.
...
**Vous risquer de perde votre progression si vous perdez ce mot de passe.**

## Serveur inaccessible : vous n'êtes pas connecté à Microsoft

Ce message apparaît souvent quand le launcher essaie de vous faire passer pour un compte officiel.
