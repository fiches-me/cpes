...
- Demander à se téléporter vers un joueur : `/tpa <pseudo>`
- Demander à un joueur de venir à vous : `/tpahere <pseudo>`
...
- Supprimer un home : `/delhome <nom>`
- Lister tes homes : `/homes`

Exemple simple : `/sethome base`, puis `/home base`.
