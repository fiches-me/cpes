...
On capital market, the capital stock can change on the long run. We specifically needs to understand how do theses changes react on prices on the long term. But as prices get higher, investment will follows. As the prices increase, the real interest rate $R = \frac{i}{P}$ decrease. 2nd element: if prices increase, you want to sell more as this will result in more profit. If prices increase, real wages are higher, so you will choose capital over labor. 

## Walras' law
As we can ignore the money market, global equilibrium can be *displayed* as follow
![](graphes/Pasted%20image%2020251118084158.png)
