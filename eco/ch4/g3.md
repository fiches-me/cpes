...
Automatic stabilizers are a way to smooth the fluctuations (chocks) of an economy. Theses works with **proportional fiscality** : having $T = t\large{y}\normalsize$

#### Document 6

1. 
    1. $\large{y}\normalsize = \frac{1}{1 - c} - cT + \overline{C} + \overline{I} + \overline{G}$. The Keynesian multiplier is $k = \frac{1}{1 - c}$
    2. $\large{y}\normalsize = \frac{1}{1 - 3/4} (1000 + 3000 + 4000 - 3000)$ = 20,000,
       $k = \frac{1}{1 - 3/4} = 4$
    3. $\Delta \large{y}\normalsize = k \times \Delta \overline{I} = 4 \times -300 = -1200$. The fiscal balance isn't changed.
2. 
    1. $\large{y}\normalsize = \frac{1}{1 - c (1 - t)} + \overline{C} + \overline{I} + \overline{G}$
...
Contrary, M3 ➡️ M0, $M3 = \frac{M0}{k}$, money is endogenous
