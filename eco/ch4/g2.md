...
Koyck also worked on a similar model, computed as $K_t = v \times Y^e_{t+1}$

In this model , the demand is not forcibly lead by the demand but more by the past demand.
