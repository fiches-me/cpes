...
Écrire une fonction avec ses paramètres et les types associés revient à écrire une **signature** de fonction. Par exemple, `def magie(m : int, k : list[bool]) ➡️ bool:` est une signature 
...
- `p.depiler() ➡️ Class` pour prendre le premier élément de la pile
