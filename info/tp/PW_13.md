...
RECURSIVE CALL TREE
  ...
  15  rec_sum(5) ➡️ rec_sum(4) ➡️ rec_sum(3) ➡️ rec_sum(2) ➡️ rec_sum(1) ➡️ rec_sum(0)
  |                                                                            |
...
RECURSIVE CALL TREE
  ...
  120  factorial(5) ➡️ factorial(4) ➡️ factorial(3) ➡️ factorial(2) ➡️ factorial(1) ➡️ factorial(0)
  |                                                                                          |                                                             |
  -   120 <- 24 × 5     24 <- 6 × 4     6 <- 2 × 3      2 <- 1 × 2      1 <- 1 × 1        0 <-
"""

def facto_it(nb : int) ➡️ int:
    # 1 instead of 0 as
